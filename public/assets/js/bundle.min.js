...
!(function(t, e) {
    ...
    function Tt(t) {
        for (
            var e = ct(t), i = Et(t); i && vt(i) && "static" === bt(i).position;
            ...
            Ft(
                (function(t) {
                    ...
                    return (
                        ...
                        (a +=
                            Lt(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
                    );
                })(yt(t))
            );
    }
    ...
    class we extends R {
        ...
        show() {
            ...
            if (!H.trigger(this._element, "show.bs.dropdown", e)
                .defaultPrevented
            ) {
                if (this._inNavbar)
