...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            ...
            <p class="lead fw-normal text-white-50 mb-0"><h1>{{$groupName->groupName}}</h1></p>
        </div>
    </div>
</header>
<!-- Section-->
        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    @endif
                    <!-- Product image-->
                    <img class="card-img-top"  src="{{url('images')}}/{{$data->photoPath}}" alt="..." width="268px" height="179px"/>
                    <!-- Product details-->
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><button class="btn btn-outline-dark mt-auto" onclick="control.watchItems(`{{$data->photoId}}`)">前往評分</button></div>
                    </div>
                </div>
            </div>
            @endforeach
