    ...
    <div class="container px-4 px-lg-5 mt-5 ">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active h4" id="nav-group-tab" data-bs-toggle="tab" data-bs-target="#nav-group" type="button" role="tab" aria-controls="nav-group" aria-selected="true">組別設置</button>
                <button class="nav-link h4" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">資料新增</button>
                <button class="nav-link h4" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">權限設置</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active row" id="nav-group" role="tabpanel" aria-labelledby="nav-group-tab">
                ...
                <form action="" id="group-form">
                    ...
                    <!-- <div class="input-group mb-3 mt-3" id="inputSection1">
                        <span class="input-group-text">Group</span>
                        <input type="text" class="form-control" name="groupInput[]">
                        <button type="button" class="input-group-text btn btn-outline-danger" onclick="Group.removeInput('inputSection1')"><i class="bi bi-trash"></i></button>
                    </div>
                    <div class="input-group mb-3 mt-3" id="inputSection2">
                        <span class="input-group-text">Group</span>
                        <input type="text" class="form-control" name="groupInput[]">
                        <button type="button" class="input-group-text btn btn-outline-danger" onclick="Group.removeInput('inputSection2')"><i class="bi bi-trash"></i></button>
                    </div> -->

                </form>
                <button type="button" class="btn btn-outline-success mt-5" id="addNewGroup" onclick="Group.addNewInput()">新增組別</button>
                <button type="button" class="btn btn-outline-primary mt-2" id="saveGroup" onclick="Group.saveGroup()">保存設置</button>
            </div>
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                <p class="text-danger">**以EXCEL檔案上傳</p>
                <form id="csv-form" method='post' enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" class=" btn btn-outline-success " onclick="File.uploadFile()"><span class="h4">上傳</span></button>
                    </div>
                </form>
            </div>
            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                <div class="d-flex align-items-start">
                    <div class="nav flex-column nav-pills me-3 p-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link active h5" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">所有帳號</button>
                        <button class="nav-link h5" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">新增帳號</button>
                            ...
                            <div class="row">
                                <form id="insertUser-form">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="account" aria-label="account" name="account" aria-describedby="account">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="chair1" aria-label="name" name="name" aria-describedby="name">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <button class="btn btn-outline-success w-100" type="submit" onclick="Group.appendChair()">新增帳號</button>
                                    </div>
